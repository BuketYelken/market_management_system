...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 25 Nis 2020, 23:21:30
...
('root', '[{\"db\":\"stock_tracking_system\",\"table\":\"stock\"},{\"db\":\"stock_tracking_system\",\"table\":\"product\"},{\"db\":\"stock_tracking_system\",\"table\":\"customers\"},{\"db\":\"stock_tracking_system\",\"table\":\"Customers\"}]');
...
('root', '2020-04-25 21:21:11', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"tr\",\"Console\\/Height\":299}');
...
ALTER TABLE `pma__savedsearches`
  MODIFY `id` int(5) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- Veritabanı: `stock_tracking_system`
--
CREATE DATABASE IF NOT EXISTS `stock_tracking_system` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `stock_tracking_system`;
...
INSERT INTO `customers` (`id`, `Name`, `Surname`, `Identify_Number`, `Phone_Number`, `Adress`, `Mail`) VALUES
(1, 'Buket', 'Yelken', '78938475854', '05547892412', 'Ankara', 'buketyelken0@gmail.com'),
(5, ' brn', 'toroooooooo', '1', '2', 'manisa', 'barantoro'),
(10, 'eray', 'y', '35', 'y5', 'tyb', 'ytr');
...
CREATE TABLE `product` (
  `Id` int(11) NOT NULL,
  `Barcode_number` mediumtext NOT NULL,
